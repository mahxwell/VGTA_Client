class Vulnerabilities:
    def __init__(self, v_id, total_v_nbr,info_v_nbr, low_v_nbr, medium_v_nbr, high_v_nbr, critical_v_nbr, ip_id,
                 ip1_id, ip2_id, ip3_id, ip4_id):
        self.v_id = v_id
        self.total_v_nbr = total_v_nbr
        self.info_v_nbr = info_v_nbr
        self.low_v_nbr = low_v_nbr
...
def rs_to_vulnerability_obj(result_set):
    v_obj = Vulnerabilities(result_set[0], result_set[1], result_set[2], result_set[3], result_set[4], result_set[5],
                            result_set[6], result_set[7], result_set[8], result_set[9], result_set[10], result_set[11])
    return v_obj